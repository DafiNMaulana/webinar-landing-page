...
<!--   <a href="#">
  ...
  <h3 align="center">Webinar template landing page</h3>

  <p align="center">
    Simple webinar template by bootstrap 5
<!--     <br />
...
<img src="https://github.com/DafiNMaulana/Best-README-Template/blob/main/images/Screenshot%20(1).png" alt="projects screenshot">
...
1. Clone the repo
   ```
   $git clone https://github.com/DafiNMaulana/webinar-landing-page.git
   ```
<p align="right">(<a href="#top">back to top</a>)</p>
